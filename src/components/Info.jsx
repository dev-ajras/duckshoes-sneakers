...
function Info() {
  return (
    <div className="flex flex-col bg-white my-3 sm:my-5">
      <div className="flex flex-col items-center p-8 sm:p-12">
        <img className="w-16 sm:w-24" src={creditCard} alt="creditCard info" />
      ...
      <span className="flex m-auto bg-grayDuck h-[3px] w-32 sm:w-48 sm:h-1"></span>
      <div className="flex flex-col items-center p-8 sm:p-12">
