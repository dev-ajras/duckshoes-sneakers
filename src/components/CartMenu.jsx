              ...
              <div key={filteredProduct.id}>
                <div className="flex gap-3 my-3 sm:gap-5 sm:my-5">
                  ...
                  <div className="w-full">
                    <h4 className="font-semibold text-md line-clamp-2 leading-6 sm:text-2xl sm:leading-8">
                      {filteredProduct.name}
                    </h4>
                    <div className="flex gap-2 font-semibold text-xs my-1 sm:gap-3 sm:text-lg sm:my-2">
                      <p>
