  ...
  return (
    <>
      <motion.div
        ...
        className="absolute top-14 right-0 z-40 w-3/4 h-screen drop-shadow-md p-2 bg-white sm:p-3"
      >
            ...
            {filteredProducts.map((filteredProduct) => (
              <div key={filteredProduct.id}>
                <div className="flex gap-3 my-3 sm:gap-5 sm:my-5">
                  ...
                  <div>
                    <h4 className="font-semibold text-lg line-clamp-2 leading-6 sm:text-2xl sm:leading-8">
                      {filteredProduct.name}
                    </h4>
                    <div className="flex gap-2 font-semibold text-sm my-1 sm:gap-3 sm:text-lg sm:my-2">
                      <p>
                    ...
                    <div className="font-bold text-xl mt-1 mb-3 sm:text-3xl sm:mt-2 sm:mb-5">
