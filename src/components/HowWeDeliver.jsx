...
function HowWeDeliver() {
  return (
    <section className="md:flex m-3 sm:m-5 max-w-6xl">
      ...
      <article className="flex justify-center">
        <div className="">
          ...
          <div className="my-3 sm:my-5">
            ...
            <p className="md:text-lg">
              Browse our website, add your desired items to the cart, and
              proceed to checkout. Input your shipping details and contact
              information.
            </p>
          </div>
          <div className="my-3 sm:my-5">
            ...
            <p className="md:text-lg">
              Once we receive your order, our dedicated team springs into
              action. We carefully pick and pack your items to ensure they
          ...
          <div className="my-3 sm:my-5">
            ...
            <p>
              ...
              arise, our friendly customer support team is always ready to
              assist you.
            </p>
          </div>
        </div>
